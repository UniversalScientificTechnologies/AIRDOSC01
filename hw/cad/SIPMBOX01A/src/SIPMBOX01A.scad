...
{ 
  ...
  crystal_refletctor_thickness = 1;
  ...
  translate([0,0,(vyska_krystalu+sila_steny+vyska_zapusti_pro_PCB+vyska_SIPM_nad_PCB+tolerance_pro_dotazeni_k_SIPM)/2]) 
    difference (){
      ...
      translate([0,0,sila_steny]) 
        cube([velikost_modulu_x * rotec_der_modulu + 2 * crystal_refletctor_thickness, velikost_modulu_y * rotec_der_modulu, vyska_krystalu+sila_steny+vyska_zapusti_pro_PCB+vyska_SIPM_nad_PCB+tolerance_pro_dotazeni_k_SIPM+0.01], center = true);
